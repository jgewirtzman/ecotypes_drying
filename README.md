...
R/                                  # Analysis scripts (run in numerical order)
  ...
  00b_prepare_zenodo_data.R         # Clean raw data for Zenodo deposit
...
data/
  raw/                              # Original data files
    ...
    Ecotypes2017_Drying_Amax.csv    # Leaf gas exchange (LI-6400)
    Ecotypes2017_Drying_Water Potential.csv
    Ecotypes2017_Drying_A-Ci.csv    # Raw A/Ci curves (LI-6400)
    Ecotypes2017_Drying_d13C.csv    # Foliar carbon isotopes
    A_Ci Ouputs.csv                 # Original A/Ci curve fits
    A_Ci Ouputs_Corrected.csv       # A/Ci fits with metadata
  processed/                        # Clean CSVs for Zenodo (generated by 00b)
    soil_moisture.csv, phenology.csv, ndvi.csv, gas_exchange.csv,
    water_potential.csv, aci_curves.csv, aci_parameters.csv,
    carbon_isotopes.csv
